...
# Usage:
#   sbatch submit_april4_ms_sngp.sh <SEED> <RUN_NAME>

REPO=/w/20252/davida/manygp/manygp
SEED=${1:?"SEED argument required"}
RUN_NAME=${2:-"ms_sngp_seed${SEED}"}
