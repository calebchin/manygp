"""
CIFAR-10 supervised classifier training with cross-entropy loss.

Usage:
    python experiments/cifar10_classifier.py --config configs/cifar10_classifier.yaml
"""
...
def main(cfg: dict) -> None:
    ...
    if run is not None:
        ...
        if saved_checkpoints:
            ...
            artifact = wandb.Artifact("cifar10_classifier_best_model", type="model")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="CIFAR-10 classifier baseline")
