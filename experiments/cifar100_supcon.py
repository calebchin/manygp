"""
CIFAR-100 supervised contrastive training with k-NN validation.

Usage:
    python experiments/cifar100_supcon.py --config configs/cifar100_supcon.yaml
"""
...
def main(cfg: dict) -> None:
    ...
    data_cfg = cfg["data"]
    train_loader, memory_loader, val_loader, train_dataset, val_dataset = get_cifar100_supcon_loaders(
    ...
    if run is not None:
        ...
        if saved_checkpoints:
            ...
            artifact = wandb.Artifact("cifar100_supcon_best_model", type="model")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="CIFAR-100 supervised contrastive experiment")
