"""
CIFAR-100 frozen-backbone SNGP training.
...
Usage:
    python experiments/cifar100_frozen_sngp.py --config configs/cifar100_frozen_sngp.yaml
"""
...
def main(cfg: dict) -> None:
    ...
    if run is not None:
        ...
        if saved_checkpoints:
            ...
            artifact = wandb.Artifact("cifar100_frozen_sngp_best_model", type="model")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="CIFAR-100 frozen-backbone shallow SNGP")
