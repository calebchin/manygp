...
from src.training.contrastive import NoAugSupConLoss, SupConLoss
...
def main(cfg: dict) -> None:
    ...
    supcon_loss_fn = NoAugSupConLoss(temperature=train_cfg["supcon_temperature"])
