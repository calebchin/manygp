"""
CIFAR-100 joint supervised contrastive + SNGP classification training.

Usage:
    python experiments/cifar100_supcon_sngp.py --config configs/cifar100_supcon_sngp.yaml
"""
...
from src.data.cifar100 import get_cifar100_supcon_loaders
...
def main(cfg: dict) -> None:
    ...
    data_cfg = cfg["data"]
    train_loader, _, val_loader, train_dataset, val_dataset = get_cifar100_supcon_loaders(
    ...
    if run is not None:
        ...
        if saved_checkpoints:
            ...
            artifact = wandb.Artifact("cifar100_supcon_sngp_best_model", type="model")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="CIFAR-100 joint SupCon + SNGP training")
